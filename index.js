...
Bienvenid@ a 
*${mdata.subject}*
Que bueno verte por aca😉, Espero que te la pases super, Recuerda ver las reglas y presentate con 
*Nombre* :
*Edad* :
*Pais* :
*Género* :
...
Usa ${prefix}verify para verificarte y poder usar el bot.`
				...
				num = anu.participants[0]
				teks = `Que bueno que te fuiste pedazo de aborto😈 @${num.split('@')[0]} ya no te queriamos ojala nunca regreses 👋`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
